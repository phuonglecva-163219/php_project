    ...
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <h2>
                    <a class="nav-link" href=""><?php echo 'Add New Post' ?></a>
                </h2>
            </li>
        </ul>
    </div>
...
<div>
    ...
    <form action="/mvc/views/add.php" method="POST" enctype="multipart/form-data">
        <div class="form-group form-inline">
            <label style="margin-left:10px; font-size:xx-large" for="title">Title:</label>
            <input name="title" style="width:25%;  position:absolute; left:40%;" type="text" class="form-control " id="title">
        </div>
        <!-- <br> -->
        <hr>
        <br>
        <div class="form-group form-inline">
            ...
            <textarea name="description" style="width:40%; min-height:150px; position:absolute; left:40%; top:200px;" class="form-control" id="desc-text"></textarea>
        </div>
        <br><br>
        <br><br>
        <hr>
        ...
        <div class="form-group form-inline">
            ...
            <div style="display: inline;">
                <input name='fileToUpload' id='fileToUpload'  style="width:40%; position:absolute; left:40%" type="file" class="form-control-file">
